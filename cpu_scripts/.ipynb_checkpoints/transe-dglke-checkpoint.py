...
dglke_model =KEModel(arg_object, 'TransE', n_entities=fb15k.n_entities, n_relations=fb15k.n_relations, hidden_dim=emb_dim, gamma=0.5, double_entity_emb=False, double_relation_emb=False)
...
for _ in tqdm(range(n_epochs)):
    fw_start = time.time()
    loss, log = dglke_model.forward(p, n, -1)
