...
# proj_mat = model.proj_mat.weight.data.clone().detach().requires_grad_(True)
...
proj_mat = xavier_uniform_(torch.randn(kg_train.n_rel, rel_dim * emb_dim)).requires_grad_(True)
